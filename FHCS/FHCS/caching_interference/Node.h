...
const int RAN_MAX =1000000; 
const double γ=0.0;          //文件受欢迎度的分布参数
//const int SEED=200;
//记得精度的问题~~~
...
const int Rate_Request =8.0;           //用户速率需求Mbps，扩大了1000倍方便将速率转换为int型,需要不断调整，直到资源数刚好用完
...
const int equation_num=5000;             //预设的等式矩阵的行数
